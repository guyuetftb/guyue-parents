...
public class EngineWordsCombine extends Configured implements Tool {

    private final static Logger logger = Logger.getLogger(EngineWordsCombine.class);
    ...
    public int run(String[] args) throws Exception {
        ...
        Job job = Job.getInstance(conf, ClassUtils.getShortClassName(EngineWordsCombine.class));
        if (job == null) {
        ...
        // set mapper
        job.setJarByClass(EngineWordsCombine.class);
    ...
    public static int executeTask(String args[]) {
        ...
        int code = 0;
        try {
            code = ToolRunner.run(new EngineWordsCombine(), args);
        } catch (Exception e) {
