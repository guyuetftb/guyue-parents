...
class Delete {
    public static void registerCommands(CommandFactory factory) {
        factory.addClass(Rm.class, "-blgrm");
        factory.addClass(Rmdir.class, "-blgrmdir");
        factory.addClass(Rmr.class, "-blgrmr");
    ...
    static class Rmr extends Rm {
        public static final String NAME = "blgrmr";
    ...
    static class Rmdir extends FsCommand {
        public static final String NAME = "blgrmdir";
