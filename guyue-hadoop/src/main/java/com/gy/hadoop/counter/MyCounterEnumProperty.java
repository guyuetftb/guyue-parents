...
public class MyCounterEnumProperty {
	...
	public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException {
		...
		// create job
		String jobName = ClassUtils.getShortClassName(MyCounterEnumProperty.class);
		...
		job.setJarByClass(MyCounterEnumProperty.class);
