 ...
 */
public class IntervalYearMonthColAddIntervalYearMonthColumn extends LongColAddLongColumn {

  private static final long serialVersionUID = 1L;

  public IntervalYearMonthColAddIntervalYearMonthColumn(int colNum1, int colNum2, int outputColumn) {
    super(colNum1, colNum2, outputColumn);
  }

  public IntervalYearMonthColAddIntervalYearMonthColumn() {
    super();
  }
