 ...
 */
public class FilterTimestampColGreaterDoubleScalar extends VectorExpression {
  ...
  public FilterTimestampColGreaterDoubleScalar(int colNum, double value) {
    this.colNum = colNum;
    this.value = value;
  }

  public FilterTimestampColGreaterDoubleScalar() {
  }
