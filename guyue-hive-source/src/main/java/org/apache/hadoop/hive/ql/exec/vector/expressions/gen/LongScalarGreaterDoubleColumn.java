 ...
 */
public class LongScalarGreaterDoubleColumn extends VectorExpression {
  ...
  public LongScalarGreaterDoubleColumn(long value, int colNum, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public LongScalarGreaterDoubleColumn() {
  }
