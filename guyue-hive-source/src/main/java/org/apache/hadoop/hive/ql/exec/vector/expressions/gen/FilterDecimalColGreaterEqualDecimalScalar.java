 ...
 * values.
 */
public class FilterDecimalColGreaterEqualDecimalScalar extends VectorExpression {
  ...
  public FilterDecimalColGreaterEqualDecimalScalar(int colNum, HiveDecimal value) {
    this.colNum = colNum;
    this.value = value;
  }

  public FilterDecimalColGreaterEqualDecimalScalar() {
  }
