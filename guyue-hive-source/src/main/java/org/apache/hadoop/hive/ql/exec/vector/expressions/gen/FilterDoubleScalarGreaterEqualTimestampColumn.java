 ...
 */
public class FilterDoubleScalarGreaterEqualTimestampColumn extends VectorExpression {
  ...
  public FilterDoubleScalarGreaterEqualTimestampColumn(double value, int colNum) {
    this.colNum = colNum;
    this.value = value;
  }
