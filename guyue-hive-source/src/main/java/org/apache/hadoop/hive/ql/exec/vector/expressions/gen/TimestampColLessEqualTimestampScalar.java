 ...
 */
public class TimestampColLessEqualTimestampScalar extends VectorExpression {
  ...
  public TimestampColLessEqualTimestampScalar(int colNum, Timestamp value, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public TimestampColLessEqualTimestampScalar() {
  }
