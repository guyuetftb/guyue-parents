 ...
 */
public class FilterDoubleScalarNotEqualTimestampColumn extends VectorExpression {
  ...
  public FilterDoubleScalarNotEqualTimestampColumn(double value, int colNum) {
    this.colNum = colNum;
    this.value = value;
  }

  public FilterDoubleScalarNotEqualTimestampColumn() {
  }
