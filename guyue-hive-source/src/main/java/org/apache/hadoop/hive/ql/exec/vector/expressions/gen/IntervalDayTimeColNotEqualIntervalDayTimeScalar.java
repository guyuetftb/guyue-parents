 ...
 */
public class IntervalDayTimeColNotEqualIntervalDayTimeScalar extends VectorExpression {
  ...
  public IntervalDayTimeColNotEqualIntervalDayTimeScalar(int colNum, HiveIntervalDayTime value, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public IntervalDayTimeColNotEqualIntervalDayTimeScalar() {
  }
