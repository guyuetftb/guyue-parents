 ...
 */
public class FilterDoubleColGreaterTimestampScalar extends org.apache.hadoop.hive.ql.exec.vector.expressions.gen.FilterDoubleColGreaterDoubleScalar {

  private static final long serialVersionUID = 1L;

  public FilterDoubleColGreaterTimestampScalar(int colNum, Timestamp value) {
    super(colNum, TimestampColumnVector.getDouble(value));
  }

  public FilterDoubleColGreaterTimestampScalar() {
    super();
  }
