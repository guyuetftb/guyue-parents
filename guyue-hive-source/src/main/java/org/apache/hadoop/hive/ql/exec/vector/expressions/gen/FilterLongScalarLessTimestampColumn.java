 ...
 */
public class FilterLongScalarLessTimestampColumn extends VectorExpression {
  ...
  public FilterLongScalarLessTimestampColumn(long value, int colNum) {
    this.colNum = colNum;
    this.value = value;
  }

  public FilterLongScalarLessTimestampColumn() {
  }
