 ...
 */
public class DoubleScalarGreaterDoubleColumn extends VectorExpression {
  ...
  public DoubleScalarGreaterDoubleColumn(double value, int colNum, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public DoubleScalarGreaterDoubleColumn() {
  }
