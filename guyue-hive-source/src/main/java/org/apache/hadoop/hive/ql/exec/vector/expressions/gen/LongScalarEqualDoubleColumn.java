 ...
 */
public class LongScalarEqualDoubleColumn extends VectorExpression {
  ...
  public LongScalarEqualDoubleColumn(long value, int colNum, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public LongScalarEqualDoubleColumn() {
  }
