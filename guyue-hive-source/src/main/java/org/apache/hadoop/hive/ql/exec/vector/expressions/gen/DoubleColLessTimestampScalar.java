 ...
 */
public class DoubleColLessTimestampScalar extends VectorExpression {
  ...
  public DoubleColLessTimestampScalar(int colNum, Timestamp value, int outputColumn) {
    this.colNum = colNum;
    this.value = TimestampColumnVector.getDouble(value);
    this.outputColumn = outputColumn;
  }

  public DoubleColLessTimestampScalar() {
  }
