 ...
 */
public class TimestampColGreaterEqualDoubleScalar extends VectorExpression {
  ...
  public TimestampColGreaterEqualDoubleScalar(int colNum, double value, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
