 ...
 */
public class IntervalDayTimeColGreaterIntervalDayTimeScalar extends VectorExpression {
  ...
  public IntervalDayTimeColGreaterIntervalDayTimeScalar(int colNum, HiveIntervalDayTime value, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public IntervalDayTimeColGreaterIntervalDayTimeScalar() {
  }
