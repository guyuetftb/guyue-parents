 ...
 */
public class TimestampScalarGreaterTimestampColumn extends VectorExpression {
  ...
  public TimestampScalarGreaterTimestampColumn(Timestamp value, int colNum, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public TimestampScalarGreaterTimestampColumn() {
  }
