 ...
 * values.
 */
public class FilterIntervalDayTimeScalarLessEqualIntervalDayTimeColumn extends VectorExpression {
  ...
  public FilterIntervalDayTimeScalarLessEqualIntervalDayTimeColumn(HiveIntervalDayTime value, int colNum) {
    this.colNum = colNum;
    this.value = value;
  }

  public FilterIntervalDayTimeScalarLessEqualIntervalDayTimeColumn() {
  }
