 ...
 */
public class FilterTimestampColGreaterEqualTimestampScalar extends VectorExpression {
  ...
  public FilterTimestampColGreaterEqualTimestampScalar(int colNum, Timestamp value) {
    this.colNum = colNum;
    this.value = value;
  }

  public FilterTimestampColGreaterEqualTimestampScalar() {
  }
