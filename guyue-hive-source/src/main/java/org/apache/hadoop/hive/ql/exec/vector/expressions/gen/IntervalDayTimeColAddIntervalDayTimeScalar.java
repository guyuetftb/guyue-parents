 ...
 */
public class IntervalDayTimeColAddIntervalDayTimeScalar extends VectorExpression {
  ...
  public IntervalDayTimeColAddIntervalDayTimeScalar(int colNum, HiveIntervalDayTime value, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public IntervalDayTimeColAddIntervalDayTimeScalar() {
  }
