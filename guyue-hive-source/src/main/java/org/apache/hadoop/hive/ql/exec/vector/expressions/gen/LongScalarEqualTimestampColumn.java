 ...
 */
public class LongScalarEqualTimestampColumn extends VectorExpression {
  ...
  public LongScalarEqualTimestampColumn(long value, int colNum, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public LongScalarEqualTimestampColumn() {
  }
