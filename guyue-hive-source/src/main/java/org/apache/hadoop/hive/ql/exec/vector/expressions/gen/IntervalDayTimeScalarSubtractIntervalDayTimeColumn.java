 ...
 */
public class IntervalDayTimeScalarSubtractIntervalDayTimeColumn extends VectorExpression {
  ...
  public IntervalDayTimeScalarSubtractIntervalDayTimeColumn(HiveIntervalDayTime value, int colNum, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public IntervalDayTimeScalarSubtractIntervalDayTimeColumn() {
  }
