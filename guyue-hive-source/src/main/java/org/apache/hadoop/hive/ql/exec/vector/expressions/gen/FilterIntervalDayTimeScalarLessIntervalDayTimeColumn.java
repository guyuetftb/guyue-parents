 ...
 * values.
 */
public class FilterIntervalDayTimeScalarLessIntervalDayTimeColumn extends VectorExpression {
  ...
  public FilterIntervalDayTimeScalarLessIntervalDayTimeColumn(HiveIntervalDayTime value, int colNum) {
    this.colNum = colNum;
    this.value = value;
  }

  public FilterIntervalDayTimeScalarLessIntervalDayTimeColumn() {
  }
