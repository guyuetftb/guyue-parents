 ...
 */
public class TimestampScalarGreaterEqualTimestampColumn extends VectorExpression {
  ...
  public TimestampScalarGreaterEqualTimestampColumn(Timestamp value, int colNum, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public TimestampScalarGreaterEqualTimestampColumn() {
  }
