 ...
 * values.
 */
public class FilterDecimalColEqualDecimalScalar extends VectorExpression {
  ...
  public FilterDecimalColEqualDecimalScalar(int colNum, HiveDecimal value) {
    this.colNum = colNum;
    this.value = value;
  }

  public FilterDecimalColEqualDecimalScalar() {
  }
