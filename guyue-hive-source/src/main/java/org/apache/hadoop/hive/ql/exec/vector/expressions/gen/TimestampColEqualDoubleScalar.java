 ...
 */
public class TimestampColEqualDoubleScalar extends VectorExpression {
  ...
  public TimestampColEqualDoubleScalar(int colNum, double value, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public TimestampColEqualDoubleScalar() {
  }
