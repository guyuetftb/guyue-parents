 ...
 */
public class FilterTimestampScalarNotEqualDoubleColumn extends org.apache.hadoop.hive.ql.exec.vector.expressions.gen.FilterDoubleScalarNotEqualDoubleColumn {

  private static final long serialVersionUID = 1L;

  public FilterTimestampScalarNotEqualDoubleColumn(Timestamp value, int colNum) {
    super(TimestampColumnVector.getDouble(value), colNum);
  }

  public FilterTimestampScalarNotEqualDoubleColumn() {
    super();
  }
