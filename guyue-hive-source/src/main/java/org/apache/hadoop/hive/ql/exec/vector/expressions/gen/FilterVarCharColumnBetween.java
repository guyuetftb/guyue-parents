 ...
 */
public class FilterVarCharColumnBetween extends VectorExpression {
  ...
  public FilterVarCharColumnBetween(int colNum, HiveVarchar left, HiveVarchar right) {
    this.colNum = colNum;
    this.left = left.getValue().getBytes();
    this.right = right.getValue().getBytes();
  }

  public FilterVarCharColumnBetween() {
  }
