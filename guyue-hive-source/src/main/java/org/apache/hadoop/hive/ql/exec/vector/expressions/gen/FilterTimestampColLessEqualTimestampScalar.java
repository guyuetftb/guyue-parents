 ...
 */
public class FilterTimestampColLessEqualTimestampScalar extends VectorExpression {
  ...
  public FilterTimestampColLessEqualTimestampScalar(int colNum, Timestamp value) {
    this.colNum = colNum;
    this.value = value;
  }

  public FilterTimestampColLessEqualTimestampScalar() {
  }
