 ...
 */
public class DoubleColEqualTimestampScalar extends VectorExpression {
  ...
  public DoubleColEqualTimestampScalar(int colNum, Timestamp value, int outputColumn) {
    this.colNum = colNum;
    this.value = TimestampColumnVector.getDouble(value);
    this.outputColumn = outputColumn;
  }

  public DoubleColEqualTimestampScalar() {
  }
