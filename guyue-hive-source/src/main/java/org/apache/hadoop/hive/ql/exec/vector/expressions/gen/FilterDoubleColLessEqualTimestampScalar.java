 ...
 */
public class FilterDoubleColLessEqualTimestampScalar extends org.apache.hadoop.hive.ql.exec.vector.expressions.gen.FilterDoubleColLessEqualDoubleScalar {

  private static final long serialVersionUID = 1L;

  public FilterDoubleColLessEqualTimestampScalar(int colNum, Timestamp value) {
    super(colNum, TimestampColumnVector.getDouble(value));
  }

  public FilterDoubleColLessEqualTimestampScalar() {
    super();
  }
