 ...
 */
public class DateColGreaterDateScalar extends org.apache.hadoop.hive.ql.exec.vector.expressions.LongColGreaterLongScalar {

  private static final long serialVersionUID = 1L;

  public DateColGreaterDateScalar(int colNum, long value, int outputColumn) {
    super(colNum, value, outputColumn);
  }

  public DateColGreaterDateScalar() {
    super();
  }
