 ...
 */
public class TimestampColLessTimestampScalar extends VectorExpression {
  ...
  public TimestampColLessTimestampScalar(int colNum, Timestamp value, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
