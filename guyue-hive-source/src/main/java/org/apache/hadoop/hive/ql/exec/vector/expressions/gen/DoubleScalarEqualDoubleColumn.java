 ...
 */
public class DoubleScalarEqualDoubleColumn extends VectorExpression {
  ...
  public DoubleScalarEqualDoubleColumn(double value, int colNum, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public DoubleScalarEqualDoubleColumn() {
  }
