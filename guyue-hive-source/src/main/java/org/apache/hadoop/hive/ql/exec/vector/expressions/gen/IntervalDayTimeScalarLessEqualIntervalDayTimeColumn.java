 ...
 */
public class IntervalDayTimeScalarLessEqualIntervalDayTimeColumn extends VectorExpression {
  ...
  public IntervalDayTimeScalarLessEqualIntervalDayTimeColumn(HiveIntervalDayTime value, int colNum, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
