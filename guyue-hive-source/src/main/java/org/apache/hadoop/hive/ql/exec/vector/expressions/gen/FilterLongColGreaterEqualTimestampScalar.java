 ...
 */
public class FilterLongColGreaterEqualTimestampScalar extends org.apache.hadoop.hive.ql.exec.vector.expressions.gen.FilterLongColGreaterEqualLongScalar {

  private static final long serialVersionUID = 1L;

  public FilterLongColGreaterEqualTimestampScalar(int colNum, Timestamp value) {
    super(colNum, TimestampColumnVector.getTimestampAsLong(value));
  }

  public FilterLongColGreaterEqualTimestampScalar() {
    super();
  }
