 ...
 */
public class FilterDoubleColNotEqualTimestampScalar extends org.apache.hadoop.hive.ql.exec.vector.expressions.gen.FilterDoubleColNotEqualDoubleScalar {

  private static final long serialVersionUID = 1L;

  public FilterDoubleColNotEqualTimestampScalar(int colNum, Timestamp value) {
    super(colNum, TimestampColumnVector.getDouble(value));
  }

  public FilterDoubleColNotEqualTimestampScalar() {
    super();
  }
