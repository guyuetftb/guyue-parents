 ...
 */
public class DateColEqualDateScalar extends org.apache.hadoop.hive.ql.exec.vector.expressions.LongColEqualLongScalar {

  private static final long serialVersionUID = 1L;

  public DateColEqualDateScalar(int colNum, long value, int outputColumn) {
    super(colNum, value, outputColumn);
  }

  public DateColEqualDateScalar() {
    super();
  }
