 ...
 */
public class DateColAddIntervalDayTimeColumn extends VectorExpression {
  ...
  public DateColAddIntervalDayTimeColumn(int colNum1, int colNum2, int outputColumn) {
  ...
  public DateColAddIntervalDayTimeColumn() {
  }
