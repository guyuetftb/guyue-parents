 ...
 */
public class IntervalYearMonthColSubtractIntervalYearMonthScalar extends LongColSubtractLongScalar {

  private static final long serialVersionUID = 1L;

  public IntervalYearMonthColSubtractIntervalYearMonthScalar(int colNum, long value, int outputColumn) {
    super(colNum, value, outputColumn);
  }

  public IntervalYearMonthColSubtractIntervalYearMonthScalar() {
    super();
  }
