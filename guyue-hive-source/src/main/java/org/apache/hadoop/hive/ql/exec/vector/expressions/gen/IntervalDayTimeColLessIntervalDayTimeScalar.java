 ...
 */
public class IntervalDayTimeColLessIntervalDayTimeScalar extends VectorExpression {
  ...
  public IntervalDayTimeColLessIntervalDayTimeScalar(int colNum, HiveIntervalDayTime value, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public IntervalDayTimeColLessIntervalDayTimeScalar() {
  }
