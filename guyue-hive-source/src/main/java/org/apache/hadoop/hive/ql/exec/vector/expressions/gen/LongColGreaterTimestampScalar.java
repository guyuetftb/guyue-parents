 ...
 */
public class LongColGreaterTimestampScalar extends VectorExpression {
  ...
  public LongColGreaterTimestampScalar(int colNum, Timestamp value, int outputColumn) {
    this.colNum = colNum;
    this.value = TimestampColumnVector.getTimestampAsLong(value);
    this.outputColumn = outputColumn;
  }

  public LongColGreaterTimestampScalar() {
  }
