 ...
 */
public class TimestampColLessEqualDoubleScalar extends VectorExpression {
  ...
  public TimestampColLessEqualDoubleScalar(int colNum, double value, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public TimestampColLessEqualDoubleScalar() {
  }
