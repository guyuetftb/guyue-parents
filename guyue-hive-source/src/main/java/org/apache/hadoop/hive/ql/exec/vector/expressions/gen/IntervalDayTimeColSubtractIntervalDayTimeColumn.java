 ...
 */
public class IntervalDayTimeColSubtractIntervalDayTimeColumn extends VectorExpression {
  ...
  public IntervalDayTimeColSubtractIntervalDayTimeColumn(int colNum1, int colNum2, int outputColumn) {
