 ...
 */
public class TimestampScalarLessEqualTimestampColumn extends VectorExpression {
  ...
  public TimestampScalarLessEqualTimestampColumn(Timestamp value, int colNum, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public TimestampScalarLessEqualTimestampColumn() {
  }
