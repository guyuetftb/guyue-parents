 ...
 */
public class TimestampColGreaterTimestampScalar extends VectorExpression {
  ...
  public TimestampColGreaterTimestampScalar(int colNum, Timestamp value, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public TimestampColGreaterTimestampScalar() {
  }
