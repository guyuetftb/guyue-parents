 ...
 */
public class TimestampScalarLessTimestampColumn extends VectorExpression {
  ...
  public TimestampScalarLessTimestampColumn(Timestamp value, int colNum, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public TimestampScalarLessTimestampColumn() {
  }
