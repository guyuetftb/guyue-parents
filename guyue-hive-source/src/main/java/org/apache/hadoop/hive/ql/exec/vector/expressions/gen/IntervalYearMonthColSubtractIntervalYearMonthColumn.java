 ...
 */
public class IntervalYearMonthColSubtractIntervalYearMonthColumn extends LongColSubtractLongColumn {

  private static final long serialVersionUID = 1L;

  public IntervalYearMonthColSubtractIntervalYearMonthColumn(int colNum1, int colNum2, int outputColumn) {
    super(colNum1, colNum2, outputColumn);
  }

  public IntervalYearMonthColSubtractIntervalYearMonthColumn() {
    super();
  }
