 ...
 */
public class TimestampColNotEqualDoubleScalar extends VectorExpression {
  ...
  public TimestampColNotEqualDoubleScalar(int colNum, double value, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public TimestampColNotEqualDoubleScalar() {
  }
