 ...
 */
public class FilterStringColumnNotBetween extends VectorExpression {
  ...
  public FilterStringColumnNotBetween(int colNum, byte[] left, byte[] right) {
    this.colNum = colNum;
    this.left = left;
    this.right = right;
  }

  public FilterStringColumnNotBetween() {
  }
