 ...
 */
public class FilterTimestampColEqualDoubleScalar extends VectorExpression {
  ...
  public FilterTimestampColEqualDoubleScalar(int colNum, double value) {
    this.colNum = colNum;
    this.value = value;
  }

  public FilterTimestampColEqualDoubleScalar() {
  }
