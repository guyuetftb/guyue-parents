 ...
 */
public class IntervalYearMonthScalarLessIntervalYearMonthColumn extends org.apache.hadoop.hive.ql.exec.vector.expressions.LongScalarLessLongColumn {

  private static final long serialVersionUID = 1L;

  public IntervalYearMonthScalarLessIntervalYearMonthColumn(long value, int colNum, int outputColumn) {
    super(value, colNum, outputColumn);
  }

  public IntervalYearMonthScalarLessIntervalYearMonthColumn() {
    super();
  }
