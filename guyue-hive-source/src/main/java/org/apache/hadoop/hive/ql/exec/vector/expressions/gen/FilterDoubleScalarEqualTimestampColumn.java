 ...
 */
public class FilterDoubleScalarEqualTimestampColumn extends VectorExpression {
  ...
  public FilterDoubleScalarEqualTimestampColumn(double value, int colNum) {
    this.colNum = colNum;
    this.value = value;
  }

  public FilterDoubleScalarEqualTimestampColumn() {
  }
