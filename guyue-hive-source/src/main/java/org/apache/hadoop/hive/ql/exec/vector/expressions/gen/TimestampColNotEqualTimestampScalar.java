 ...
 */
public class TimestampColNotEqualTimestampScalar extends VectorExpression {
  ...
  public TimestampColNotEqualTimestampScalar(int colNum, Timestamp value, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public TimestampColNotEqualTimestampScalar() {
  }
