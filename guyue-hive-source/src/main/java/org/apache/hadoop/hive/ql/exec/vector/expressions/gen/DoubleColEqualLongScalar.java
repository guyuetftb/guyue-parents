 ...
 */
public class DoubleColEqualLongScalar extends VectorExpression {
  ...
  public DoubleColEqualLongScalar(int colNum, long value, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public DoubleColEqualLongScalar() {
  }
