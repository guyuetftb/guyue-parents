 ...
 */
public class TimestampColAddIntervalDayTimeScalar extends VectorExpression {
  ...
  public TimestampColAddIntervalDayTimeScalar(int colNum, HiveIntervalDayTime value, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public TimestampColAddIntervalDayTimeScalar() {
  }
