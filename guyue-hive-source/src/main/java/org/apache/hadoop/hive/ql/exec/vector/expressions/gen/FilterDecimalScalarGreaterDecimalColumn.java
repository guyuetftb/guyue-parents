 ...
 * values.
 */
public class FilterDecimalScalarGreaterDecimalColumn extends VectorExpression {
  ...
  public FilterDecimalScalarGreaterDecimalColumn(HiveDecimal value, int colNum) {
    this.colNum = colNum;
    this.value = value;
  }

  public FilterDecimalScalarGreaterDecimalColumn() {
  }
