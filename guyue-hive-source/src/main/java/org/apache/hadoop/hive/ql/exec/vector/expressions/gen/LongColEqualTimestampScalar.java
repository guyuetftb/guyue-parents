 ...
 */
public class LongColEqualTimestampScalar extends VectorExpression {
  ...
  public LongColEqualTimestampScalar(int colNum, Timestamp value, int outputColumn) {
    this.colNum = colNum;
    this.value = TimestampColumnVector.getTimestampAsLong(value);
    this.outputColumn = outputColumn;
  }

  public LongColEqualTimestampScalar() {
  }
