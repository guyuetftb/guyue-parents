...
/**
* VectorUDAFVarSampDecimal. Vectorized implementation for VARIANCE aggregates.
*/
@Description(name = "var_samp",
    value = "_FUNC_(x) - Returns the sample variance of a set of numbers (vectorized, decimal)")
public class VectorUDAFVarSampDecimal extends VectorAggregateExpression {
