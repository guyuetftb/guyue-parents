 ...
 * values.
 */
public class FilterDecimalColLessDecimalScalar extends VectorExpression {
  ...
  public FilterDecimalColLessDecimalScalar(int colNum, HiveDecimal value) {
    this.colNum = colNum;
    this.value = value;
  }

  public FilterDecimalColLessDecimalScalar() {
  }
