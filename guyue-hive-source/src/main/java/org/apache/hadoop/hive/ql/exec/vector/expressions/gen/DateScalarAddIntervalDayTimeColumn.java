 ...
 */
public class DateScalarAddIntervalDayTimeColumn extends VectorExpression {
  ...
  public DateScalarAddIntervalDayTimeColumn(long value, int colNum, int outputColumn) {
    this.colNum = colNum;
  ...
  public DateScalarAddIntervalDayTimeColumn() {
  }
