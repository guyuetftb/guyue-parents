 ...
 * values.
 */
public class FilterTimestampScalarGreaterTimestampColumn extends VectorExpression {
  ...
  public FilterTimestampScalarGreaterTimestampColumn(Timestamp value, int colNum) {
    this.colNum = colNum;
    this.value = value;
  }

  public FilterTimestampScalarGreaterTimestampColumn() {
  }
