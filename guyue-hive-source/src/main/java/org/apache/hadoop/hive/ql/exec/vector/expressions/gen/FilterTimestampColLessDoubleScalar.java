 ...
 */
public class FilterTimestampColLessDoubleScalar extends VectorExpression {
  ...
  public FilterTimestampColLessDoubleScalar(int colNum, double value) {
    this.colNum = colNum;
    this.value = value;
  }

  public FilterTimestampColLessDoubleScalar() {
  }
