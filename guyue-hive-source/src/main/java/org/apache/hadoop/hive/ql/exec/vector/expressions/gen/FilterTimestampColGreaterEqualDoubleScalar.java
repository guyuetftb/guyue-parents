 ...
 */
public class FilterTimestampColGreaterEqualDoubleScalar extends VectorExpression {
  ...
  public FilterTimestampColGreaterEqualDoubleScalar(int colNum, double value) {
    this.colNum = colNum;
    this.value = value;
  }
