 ...
 */
public class IntervalDayTimeColAddDateColumn extends VectorExpression {
  ...
  public IntervalDayTimeColAddDateColumn(int colNum1, int colNum2, int outputColumn) {
  ...
  public IntervalDayTimeColAddDateColumn() {
  }
  ...
  public void evaluate(VectorizedRowBatch batch) {
    ...
    if (inputColVector1.isRepeating && inputColVector2.isRepeating) {
      ...
      dtm.add(
          inputColVector1.asScratchIntervalDayTime(0), scratchTimestamp2, outputColVector.getScratchTimestamp());
      ...
      if (batch.selectedInUse) {
        for(int j = 0; j != n; j++) {
          ...
          dtm.add(
              value1, scratchTimestamp2, outputColVector.getScratchTimestamp());
      ...
      if (batch.selectedInUse) {
        for(int j = 0; j != n; j++) {
          int i = sel[j];
          dtm.add(
              inputColVector1.asScratchIntervalDayTime(i), scratchTimestamp2, outputColVector.getScratchTimestamp());
          outputColVector.setFromScratchTimestamp(i);
        }
      } else {
        for(int i = 0; i != n; i++) {
