 ...
 */
public class TimestampColSubtractIntervalDayTimeScalar extends VectorExpression {
  ...
  public TimestampColSubtractIntervalDayTimeScalar(int colNum, HiveIntervalDayTime value, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public TimestampColSubtractIntervalDayTimeScalar() {
  }
