 ...
 */
public class TimestampColGreaterEqualTimestampScalar extends VectorExpression {
  ...
  public TimestampColGreaterEqualTimestampScalar(int colNum, Timestamp value, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
