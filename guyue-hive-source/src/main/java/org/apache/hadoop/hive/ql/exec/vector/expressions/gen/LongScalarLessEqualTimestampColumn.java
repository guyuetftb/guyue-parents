 ...
 */
public class LongScalarLessEqualTimestampColumn extends VectorExpression {
  ...
  public LongScalarLessEqualTimestampColumn(long value, int colNum, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public LongScalarLessEqualTimestampColumn() {
  }
