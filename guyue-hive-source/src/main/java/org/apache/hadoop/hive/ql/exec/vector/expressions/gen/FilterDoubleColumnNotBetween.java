 ...
 */
public class FilterDoubleColumnNotBetween extends VectorExpression {
  ...
  public FilterDoubleColumnNotBetween(int colNum, double leftValue, double rightValue) { 
    this.colNum = colNum;
    this.leftValue = leftValue;
    this.rightValue = rightValue;
  }

  public FilterDoubleColumnNotBetween() {
  }
