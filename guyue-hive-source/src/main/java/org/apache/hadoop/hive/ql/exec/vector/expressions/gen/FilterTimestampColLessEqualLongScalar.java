 ...
 */
public class FilterTimestampColLessEqualLongScalar extends VectorExpression {
  ...
  public FilterTimestampColLessEqualLongScalar(int colNum, long value) {
    this.colNum = colNum;
    this.value = value;
  }

  public FilterTimestampColLessEqualLongScalar() {
  }
