 ...
 */
public class StringGroupColGreaterEqualVarCharScalar extends StringGroupColGreaterEqualStringGroupScalarBase {

  public StringGroupColGreaterEqualVarCharScalar(int colNum, HiveVarchar value, int outputColumn) {
    this.colNum = colNum;
    this.value = value.getValue().getBytes();
    this.outputColumn = outputColumn;
  }

  public StringGroupColGreaterEqualVarCharScalar() {
  }
