 ...
 */
public class DateScalarLessEqualDateColumn extends org.apache.hadoop.hive.ql.exec.vector.expressions.LongScalarLessEqualLongColumn {

  private static final long serialVersionUID = 1L;

  public DateScalarLessEqualDateColumn(long value, int colNum, int outputColumn) {
    super(value, colNum, outputColumn);
  }

  public DateScalarLessEqualDateColumn() {
    super();
  }
