 ...
 */
public class TimestampScalarAddIntervalDayTimeColumn extends VectorExpression {
  ...
  public TimestampScalarAddIntervalDayTimeColumn(Timestamp value, int colNum, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public TimestampScalarAddIntervalDayTimeColumn() {
  }
