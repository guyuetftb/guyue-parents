 ...
 */
public class StringGroupColGreaterVarCharScalar extends StringGroupColGreaterStringGroupScalarBase {

  public StringGroupColGreaterVarCharScalar(int colNum, HiveVarchar value, int outputColumn) {
    this.colNum = colNum;
    this.value = value.getValue().getBytes();
    this.outputColumn = outputColumn;
  }

  public StringGroupColGreaterVarCharScalar() {
  }
