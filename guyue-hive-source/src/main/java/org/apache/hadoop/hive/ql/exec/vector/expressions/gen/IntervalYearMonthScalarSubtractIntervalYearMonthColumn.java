 ...
 */
public class IntervalYearMonthScalarSubtractIntervalYearMonthColumn extends LongScalarSubtractLongColumn {

  private static final long serialVersionUID = 1L;

  public IntervalYearMonthScalarSubtractIntervalYearMonthColumn(long value, int colNum, int outputColumn) {
    super(value, colNum, outputColumn);
  }

  public IntervalYearMonthScalarSubtractIntervalYearMonthColumn() {
    super();
  }
