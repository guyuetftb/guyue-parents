 ...
 */
public class DoubleColGreaterTimestampScalar extends VectorExpression {
  ...
  public DoubleColGreaterTimestampScalar(int colNum, Timestamp value, int outputColumn) {
    this.colNum = colNum;
    this.value = TimestampColumnVector.getDouble(value);
    this.outputColumn = outputColumn;
  }

  public DoubleColGreaterTimestampScalar() {
  }
