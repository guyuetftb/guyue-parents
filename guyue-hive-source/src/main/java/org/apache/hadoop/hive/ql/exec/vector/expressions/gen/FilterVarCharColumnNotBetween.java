 ...
 */
public class FilterVarCharColumnNotBetween extends VectorExpression {
  ...
  public FilterVarCharColumnNotBetween(int colNum, HiveVarchar left, HiveVarchar right) {
    this.colNum = colNum;
    this.left = left.getValue().getBytes();
    this.right = right.getValue().getBytes();
  }

  public FilterVarCharColumnNotBetween() {
  }
