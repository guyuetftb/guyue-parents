 ...
 * values.
 */
public class FilterDecimalScalarLessDecimalColumn extends VectorExpression {
  ...
  public FilterDecimalScalarLessDecimalColumn(HiveDecimal value, int colNum) {
    this.colNum = colNum;
    this.value = value;
  }

  public FilterDecimalScalarLessDecimalColumn() {
  }
