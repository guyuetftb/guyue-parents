...
/**
* VectorUDAFMinIntervalDayTime. Vectorized implementation for MIN/MAX aggregates.
*/
@Description(name = "min",
    value = "_FUNC_(expr) - Returns the minimum value of expr (vectorized, type: interval_day_time)")
public class VectorUDAFMinIntervalDayTime extends VectorAggregateExpression {
    ...
    public VectorUDAFMinIntervalDayTime(VectorExpression inputExpression) {
      this();
      this.inputExpression = inputExpression;
    }

    public VectorUDAFMinIntervalDayTime() {
      super();
    }
