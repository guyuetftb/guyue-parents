 ...
 */
public class DoubleColLessEqualTimestampScalar extends VectorExpression {
  ...
  public DoubleColLessEqualTimestampScalar(int colNum, Timestamp value, int outputColumn) {
    this.colNum = colNum;
    this.value = TimestampColumnVector.getDouble(value);
    this.outputColumn = outputColumn;
  }

  public DoubleColLessEqualTimestampScalar() {
  }
