 ...
 */
public class DoubleScalarGreaterLongColumn extends VectorExpression {
  ...
  public DoubleScalarGreaterLongColumn(double value, int colNum, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public DoubleScalarGreaterLongColumn() {
  }
