 ...
 */
public class DoubleScalarEqualLongColumn extends VectorExpression {
  ...
  public DoubleScalarEqualLongColumn(double value, int colNum, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public DoubleScalarEqualLongColumn() {
  }
