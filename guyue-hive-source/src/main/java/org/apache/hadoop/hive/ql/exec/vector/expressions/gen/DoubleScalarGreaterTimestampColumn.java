 ...
 */
public class DoubleScalarGreaterTimestampColumn extends VectorExpression {
  ...
  public DoubleScalarGreaterTimestampColumn(double value, int colNum, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public DoubleScalarGreaterTimestampColumn() {
  }
