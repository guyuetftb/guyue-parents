 ...
 * values.
 */
public class FilterIntervalDayTimeScalarEqualIntervalDayTimeColumn extends VectorExpression {
  ...
  public FilterIntervalDayTimeScalarEqualIntervalDayTimeColumn(HiveIntervalDayTime value, int colNum) {
    this.colNum = colNum;
    this.value = value;
  }

  public FilterIntervalDayTimeScalarEqualIntervalDayTimeColumn() {
  }
