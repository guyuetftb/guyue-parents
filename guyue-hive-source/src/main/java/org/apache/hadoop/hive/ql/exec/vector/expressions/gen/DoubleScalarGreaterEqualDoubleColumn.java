 ...
 */
public class DoubleScalarGreaterEqualDoubleColumn extends VectorExpression {
  ...
  public DoubleScalarGreaterEqualDoubleColumn(double value, int colNum, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public DoubleScalarGreaterEqualDoubleColumn() {
  }
