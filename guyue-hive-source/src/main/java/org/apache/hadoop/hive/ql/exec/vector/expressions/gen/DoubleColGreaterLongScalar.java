 ...
 */
public class DoubleColGreaterLongScalar extends VectorExpression {
  ...
  public DoubleColGreaterLongScalar(int colNum, long value, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public DoubleColGreaterLongScalar() {
  }
