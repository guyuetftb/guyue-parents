 ...
 */
public class LongScalarNotEqualDoubleColumn extends VectorExpression {
  ...
  public LongScalarNotEqualDoubleColumn(long value, int colNum, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public LongScalarNotEqualDoubleColumn() {
  }
