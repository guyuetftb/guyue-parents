 ...
 */
public class TimestampColEqualLongScalar extends VectorExpression {
  ...
  public TimestampColEqualLongScalar(int colNum, long value, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public TimestampColEqualLongScalar() {
  }
