 ...
 * values.
 */
public class FilterDecimalColLessEqualDecimalScalar extends VectorExpression {
  ...
  public FilterDecimalColLessEqualDecimalScalar(int colNum, HiveDecimal value) {
    this.colNum = colNum;
    this.value = value;
  }

  public FilterDecimalColLessEqualDecimalScalar() {
  }
