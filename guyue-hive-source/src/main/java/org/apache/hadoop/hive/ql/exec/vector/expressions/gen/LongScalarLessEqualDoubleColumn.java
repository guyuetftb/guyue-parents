 ...
 */
public class LongScalarLessEqualDoubleColumn extends VectorExpression {
  ...
  public LongScalarLessEqualDoubleColumn(long value, int colNum, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public LongScalarLessEqualDoubleColumn() {
  }
