 ...
 * values.
 */
public class FilterTimestampScalarLessEqualTimestampColumn extends VectorExpression {
  ...
  public FilterTimestampScalarLessEqualTimestampColumn(Timestamp value, int colNum) {
    this.colNum = colNum;
    this.value = value;
  }

  public FilterTimestampScalarLessEqualTimestampColumn() {
  }
