 ...
 */
public class FilterTimestampColLessLongScalar extends VectorExpression {
  ...
  public FilterTimestampColLessLongScalar(int colNum, long value) {
    this.colNum = colNum;
    this.value = value;
  }

  public FilterTimestampColLessLongScalar() {
  }
