 ...
 */
public class FilterTimestampColumnNotBetween extends VectorExpression {
  ...
  public FilterTimestampColumnNotBetween(int colNum, Timestamp leftValue, Timestamp rightValue) {
    this.colNum = colNum;
    this.leftValue = leftValue;
    this.rightValue = rightValue;
  }

  public FilterTimestampColumnNotBetween() {
  }
