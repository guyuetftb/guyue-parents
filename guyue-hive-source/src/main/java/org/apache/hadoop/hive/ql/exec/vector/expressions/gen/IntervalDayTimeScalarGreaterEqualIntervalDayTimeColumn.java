 ...
 */
public class IntervalDayTimeScalarGreaterEqualIntervalDayTimeColumn extends VectorExpression {
  ...
  public IntervalDayTimeScalarGreaterEqualIntervalDayTimeColumn(HiveIntervalDayTime value, int colNum, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public IntervalDayTimeScalarGreaterEqualIntervalDayTimeColumn() {
  }
