 ...
 */
public class DateColAddIntervalDayTimeScalar extends VectorExpression {
  ...
  public DateColAddIntervalDayTimeScalar(int colNum, HiveIntervalDayTime value, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
