 ...
 */
public class LongScalarGreaterEqualDoubleColumn extends VectorExpression {
  ...
  public LongScalarGreaterEqualDoubleColumn(long value, int colNum, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public LongScalarGreaterEqualDoubleColumn() {
  }
