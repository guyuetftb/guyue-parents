 ...
 */
public class DoubleScalarNotEqualDoubleColumn extends VectorExpression {
  ...
  public DoubleScalarNotEqualDoubleColumn(double value, int colNum, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public DoubleScalarNotEqualDoubleColumn() {
  }
