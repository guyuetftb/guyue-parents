 ...
 */
public class LongScalarNotEqualTimestampColumn extends VectorExpression {
  ...
  public LongScalarNotEqualTimestampColumn(long value, int colNum, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public LongScalarNotEqualTimestampColumn() {
  }
