 ...
 */
public class DoubleScalarEqualTimestampColumn extends VectorExpression {
  ...
  public DoubleScalarEqualTimestampColumn(double value, int colNum, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public DoubleScalarEqualTimestampColumn() {
  }
