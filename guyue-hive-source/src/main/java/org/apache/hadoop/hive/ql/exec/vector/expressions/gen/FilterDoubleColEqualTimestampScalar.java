 ...
 */
public class FilterDoubleColEqualTimestampScalar extends org.apache.hadoop.hive.ql.exec.vector.expressions.gen.FilterDoubleColEqualDoubleScalar {

  private static final long serialVersionUID = 1L;

  public FilterDoubleColEqualTimestampScalar(int colNum, Timestamp value) {
    super(colNum, TimestampColumnVector.getDouble(value));
  }

  public FilterDoubleColEqualTimestampScalar() {
    super();
  }
