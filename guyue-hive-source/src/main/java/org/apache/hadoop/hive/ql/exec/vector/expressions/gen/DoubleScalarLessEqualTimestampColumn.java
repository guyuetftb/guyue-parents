 ...
 */
public class DoubleScalarLessEqualTimestampColumn extends VectorExpression {
  ...
  public DoubleScalarLessEqualTimestampColumn(double value, int colNum, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public DoubleScalarLessEqualTimestampColumn() {
  }
