 ...
 */
public class TimestampColAddIntervalYearMonthColumn extends VectorExpression {
  ...
  public TimestampColAddIntervalYearMonthColumn(int colNum1, int colNum2, int outputColumn) {
  ...
  public TimestampColAddIntervalYearMonthColumn() {
  }
