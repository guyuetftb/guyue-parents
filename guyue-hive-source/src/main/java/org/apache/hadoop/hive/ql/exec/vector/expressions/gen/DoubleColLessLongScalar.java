 ...
 */
public class DoubleColLessLongScalar extends VectorExpression {
  ...
  public DoubleColLessLongScalar(int colNum, long value, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public DoubleColLessLongScalar() {
  }
