 ...
 */
public class DoubleScalarNotEqualLongColumn extends VectorExpression {
  ...
  public DoubleScalarNotEqualLongColumn(double value, int colNum, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public DoubleScalarNotEqualLongColumn() {
  }
