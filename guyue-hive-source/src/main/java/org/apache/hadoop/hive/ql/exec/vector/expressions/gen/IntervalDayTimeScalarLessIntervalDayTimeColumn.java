 ...
 */
public class IntervalDayTimeScalarLessIntervalDayTimeColumn extends VectorExpression {
  ...
  public IntervalDayTimeScalarLessIntervalDayTimeColumn(HiveIntervalDayTime value, int colNum, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public IntervalDayTimeScalarLessIntervalDayTimeColumn() {
  }
