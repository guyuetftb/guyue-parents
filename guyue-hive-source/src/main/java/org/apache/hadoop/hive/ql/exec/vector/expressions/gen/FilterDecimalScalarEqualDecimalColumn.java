 ...
 * values.
 */
public class FilterDecimalScalarEqualDecimalColumn extends VectorExpression {
  ...
  public FilterDecimalScalarEqualDecimalColumn(HiveDecimal value, int colNum) {
    this.colNum = colNum;
    this.value = value;
  }

  public FilterDecimalScalarEqualDecimalColumn() {
  }
