 ...
 */
public class DateColNotEqualDateScalar extends org.apache.hadoop.hive.ql.exec.vector.expressions.LongColNotEqualLongScalar {

  private static final long serialVersionUID = 1L;

  public DateColNotEqualDateScalar(int colNum, long value, int outputColumn) {
    super(colNum, value, outputColumn);
  }

  public DateColNotEqualDateScalar() {
    super();
  }
