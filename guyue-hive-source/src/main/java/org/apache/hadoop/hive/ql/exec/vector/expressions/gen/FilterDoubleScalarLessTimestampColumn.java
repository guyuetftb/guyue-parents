 ...
 */
public class FilterDoubleScalarLessTimestampColumn extends VectorExpression {
  ...
  public FilterDoubleScalarLessTimestampColumn(double value, int colNum) {
    this.colNum = colNum;
    this.value = value;
  }

  public FilterDoubleScalarLessTimestampColumn() {
  }
