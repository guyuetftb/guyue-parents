 ...
 */
public class TimestampColSubtractDateColumn extends VectorExpression {
  ...
  public TimestampColSubtractDateColumn(int colNum1, int colNum2, int outputColumn) {
  ...
  public void evaluate(VectorizedRowBatch batch) {
    ...
    if (inputColVector1.isRepeating && inputColVector2.isRepeating) {
      ...
      dtm.subtract(
          inputColVector1.asScratchTimestamp(0), scratchTimestamp2, outputColVector.getScratchIntervalDayTime());
      ...
      if (batch.selectedInUse) {
        for(int j = 0; j != n; j++) {
          ...
          dtm.subtract(
              value1, scratchTimestamp2, outputColVector.getScratchIntervalDayTime());
      ...
      if (batch.selectedInUse) {
        for(int j = 0; j != n; j++) {
          int i = sel[j];
          dtm.subtract(
              inputColVector1.asScratchTimestamp(i), scratchTimestamp2, outputColVector.getScratchIntervalDayTime());
          outputColVector.setFromScratchIntervalDayTime(i);
        }
      } else {
        for(int i = 0; i != n; i++) {
