 ...
 */
public class TimestampColEqualTimestampScalar extends VectorExpression {
  ...
  public TimestampColEqualTimestampScalar(int colNum, Timestamp value, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public TimestampColEqualTimestampScalar() {
  }
