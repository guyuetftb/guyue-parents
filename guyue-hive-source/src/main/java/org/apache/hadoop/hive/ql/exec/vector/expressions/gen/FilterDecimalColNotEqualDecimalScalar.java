 ...
 * values.
 */
public class FilterDecimalColNotEqualDecimalScalar extends VectorExpression {
  ...
  public FilterDecimalColNotEqualDecimalScalar(int colNum, HiveDecimal value) {
    this.colNum = colNum;
    this.value = value;
  }

  public FilterDecimalColNotEqualDecimalScalar() {
  }
