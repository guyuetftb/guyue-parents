 ...
 */
public class FilterLongColGreaterTimestampScalar extends org.apache.hadoop.hive.ql.exec.vector.expressions.gen.FilterLongColGreaterLongScalar {

  private static final long serialVersionUID = 1L;

  public FilterLongColGreaterTimestampScalar(int colNum, Timestamp value) {
    super(colNum, TimestampColumnVector.getTimestampAsLong(value));
  }

  public FilterLongColGreaterTimestampScalar() {
    super();
  }
