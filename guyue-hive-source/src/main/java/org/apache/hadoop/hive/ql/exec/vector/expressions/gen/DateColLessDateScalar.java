 ...
 */
public class DateColLessDateScalar extends org.apache.hadoop.hive.ql.exec.vector.expressions.LongColLessLongScalar {

  private static final long serialVersionUID = 1L;

  public DateColLessDateScalar(int colNum, long value, int outputColumn) {
    super(colNum, value, outputColumn);
  }

  public DateColLessDateScalar() {
    super();
  }
