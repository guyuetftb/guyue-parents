 ...
 */
public class TimestampScalarSubtractTimestampColumn extends VectorExpression {
  ...
  public TimestampScalarSubtractTimestampColumn(Timestamp value, int colNum, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public TimestampScalarSubtractTimestampColumn() {
  }
