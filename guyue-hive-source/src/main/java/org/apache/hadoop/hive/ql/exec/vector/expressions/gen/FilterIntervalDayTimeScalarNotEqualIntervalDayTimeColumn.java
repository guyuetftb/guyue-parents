 ...
 * values.
 */
public class FilterIntervalDayTimeScalarNotEqualIntervalDayTimeColumn extends VectorExpression {
  ...
  public FilterIntervalDayTimeScalarNotEqualIntervalDayTimeColumn(HiveIntervalDayTime value, int colNum) {
    this.colNum = colNum;
    this.value = value;
  }

  public FilterIntervalDayTimeScalarNotEqualIntervalDayTimeColumn() {
  }
