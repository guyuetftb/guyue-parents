 ...
 */
public class DoubleColGreaterEqualTimestampScalar extends VectorExpression {
  ...
  public DoubleColGreaterEqualTimestampScalar(int colNum, Timestamp value, int outputColumn) {
    this.colNum = colNum;
    this.value = TimestampColumnVector.getDouble(value);
    this.outputColumn = outputColumn;
  }

  public DoubleColGreaterEqualTimestampScalar() {
  }
