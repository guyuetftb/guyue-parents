 ...
 */
public class StringGroupColEqualVarCharScalar extends StringGroupColEqualStringGroupScalarBase {

  public StringGroupColEqualVarCharScalar(int colNum, HiveVarchar value, int outputColumn) {
    this.colNum = colNum;
    this.value = value.getValue().getBytes();
    this.outputColumn = outputColumn;
  }

  public StringGroupColEqualVarCharScalar() {
  }
