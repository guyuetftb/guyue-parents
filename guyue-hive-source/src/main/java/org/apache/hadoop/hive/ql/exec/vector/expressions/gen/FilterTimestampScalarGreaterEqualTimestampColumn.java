 ...
 * values.
 */
public class FilterTimestampScalarGreaterEqualTimestampColumn extends VectorExpression {
  ...
  public FilterTimestampScalarGreaterEqualTimestampColumn(Timestamp value, int colNum) {
    this.colNum = colNum;
    this.value = value;
  }

  public FilterTimestampScalarGreaterEqualTimestampColumn() {
  }
