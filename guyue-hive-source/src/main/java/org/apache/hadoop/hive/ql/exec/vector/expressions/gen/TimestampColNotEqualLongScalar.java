 ...
 */
public class TimestampColNotEqualLongScalar extends VectorExpression {
  ...
  public TimestampColNotEqualLongScalar(int colNum, long value, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public TimestampColNotEqualLongScalar() {
  }
