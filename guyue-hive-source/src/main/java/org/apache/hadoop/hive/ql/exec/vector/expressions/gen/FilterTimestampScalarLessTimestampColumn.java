 ...
 * values.
 */
public class FilterTimestampScalarLessTimestampColumn extends VectorExpression {
  ...
  public FilterTimestampScalarLessTimestampColumn(Timestamp value, int colNum) {
    this.colNum = colNum;
    this.value = value;
  }

  public FilterTimestampScalarLessTimestampColumn() {
  }
