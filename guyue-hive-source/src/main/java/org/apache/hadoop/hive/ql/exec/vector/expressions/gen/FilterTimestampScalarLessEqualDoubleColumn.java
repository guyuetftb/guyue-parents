 ...
 */
public class FilterTimestampScalarLessEqualDoubleColumn extends org.apache.hadoop.hive.ql.exec.vector.expressions.gen.FilterDoubleScalarLessEqualDoubleColumn {

  private static final long serialVersionUID = 1L;

  public FilterTimestampScalarLessEqualDoubleColumn(Timestamp value, int colNum) {
    super(TimestampColumnVector.getDouble(value), colNum);
  }

  public FilterTimestampScalarLessEqualDoubleColumn() {
    super();
  }
