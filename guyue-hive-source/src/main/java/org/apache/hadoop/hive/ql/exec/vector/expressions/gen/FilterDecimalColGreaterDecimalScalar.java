 ...
 * values.
 */
public class FilterDecimalColGreaterDecimalScalar extends VectorExpression {
  ...
  public FilterDecimalColGreaterDecimalScalar(int colNum, HiveDecimal value) {
    this.colNum = colNum;
    this.value = value;
  }

  public FilterDecimalColGreaterDecimalScalar() {
  }
