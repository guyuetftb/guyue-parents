 ...
 */
public class FilterLongColEqualTimestampScalar extends org.apache.hadoop.hive.ql.exec.vector.expressions.gen.FilterLongColEqualLongScalar {

  private static final long serialVersionUID = 1L;

  public FilterLongColEqualTimestampScalar(int colNum, Timestamp value) {
    super(colNum, TimestampColumnVector.getTimestampAsLong(value));
  }

  public FilterLongColEqualTimestampScalar() {
    super();
  }
