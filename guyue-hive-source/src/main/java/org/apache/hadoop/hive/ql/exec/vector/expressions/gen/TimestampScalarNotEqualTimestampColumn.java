 ...
 */
public class TimestampScalarNotEqualTimestampColumn extends VectorExpression {
  ...
  public TimestampScalarNotEqualTimestampColumn(Timestamp value, int colNum, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public TimestampScalarNotEqualTimestampColumn() {
  }
