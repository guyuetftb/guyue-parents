 ...
 */
public class FilterTimestampColEqualLongScalar extends VectorExpression {
  ...
  public FilterTimestampColEqualLongScalar(int colNum, long value) {
    this.colNum = colNum;
    this.value = value;
  }

  public FilterTimestampColEqualLongScalar() {
  }
