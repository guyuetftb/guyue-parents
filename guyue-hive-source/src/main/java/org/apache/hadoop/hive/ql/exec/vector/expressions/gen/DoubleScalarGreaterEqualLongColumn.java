 ...
 */
public class DoubleScalarGreaterEqualLongColumn extends VectorExpression {
  ...
  public DoubleScalarGreaterEqualLongColumn(double value, int colNum, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public DoubleScalarGreaterEqualLongColumn() {
  }
