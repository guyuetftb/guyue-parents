 ...
 */
public class TimestampColLessEqualLongScalar extends VectorExpression {
  ...
  public TimestampColLessEqualLongScalar(int colNum, long value, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public TimestampColLessEqualLongScalar() {
  }
