 ...
 */
public class FilterDoubleColLessTimestampScalar extends org.apache.hadoop.hive.ql.exec.vector.expressions.gen.FilterDoubleColLessDoubleScalar {

  private static final long serialVersionUID = 1L;

  public FilterDoubleColLessTimestampScalar(int colNum, Timestamp value) {
    super(colNum, TimestampColumnVector.getDouble(value));
  }

  public FilterDoubleColLessTimestampScalar() {
    super();
  }
