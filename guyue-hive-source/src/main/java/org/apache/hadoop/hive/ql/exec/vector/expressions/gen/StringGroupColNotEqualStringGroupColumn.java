 ...
 */
public class StringGroupColNotEqualStringGroupColumn extends VectorExpression {
  ...
  public StringGroupColNotEqualStringGroupColumn(int colNum1, int colNum2, int outputColumn) { 
  ...
  public void evaluate(VectorizedRowBatch batch) {
    ...
    if (inputColVector1.noNulls && inputColVector2.noNulls) {
      ...
      if (inputColVector1.isRepeating && inputColVector2.isRepeating) {
        ...
        boolean ret = !StringExpr.equal(vector1[0], start1[0], length1[0], 
