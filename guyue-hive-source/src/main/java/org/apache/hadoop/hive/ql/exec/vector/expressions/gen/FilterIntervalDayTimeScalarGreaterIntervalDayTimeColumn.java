 ...
 * values.
 */
public class FilterIntervalDayTimeScalarGreaterIntervalDayTimeColumn extends VectorExpression {
  ...
  public FilterIntervalDayTimeScalarGreaterIntervalDayTimeColumn(HiveIntervalDayTime value, int colNum) {
    this.colNum = colNum;
    this.value = value;
  }

  public FilterIntervalDayTimeScalarGreaterIntervalDayTimeColumn() {
  }
