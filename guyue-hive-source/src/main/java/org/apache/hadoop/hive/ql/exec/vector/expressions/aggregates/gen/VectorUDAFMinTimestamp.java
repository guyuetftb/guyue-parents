...
/**
* VectorUDAFMinTimestamp. Vectorized implementation for MIN/MAX aggregates.
*/
@Description(name = "min",
    value = "_FUNC_(expr) - Returns the minimum value of expr (vectorized, type: timestamp)")
public class VectorUDAFMinTimestamp extends VectorAggregateExpression {
    ...
    public VectorUDAFMinTimestamp(VectorExpression inputExpression) {
      this();
      this.inputExpression = inputExpression;
    }

    public VectorUDAFMinTimestamp() {
      super();
    }
