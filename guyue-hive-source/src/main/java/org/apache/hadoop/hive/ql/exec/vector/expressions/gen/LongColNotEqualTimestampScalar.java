 ...
 */
public class LongColNotEqualTimestampScalar extends VectorExpression {
  ...
  public LongColNotEqualTimestampScalar(int colNum, Timestamp value, int outputColumn) {
    this.colNum = colNum;
    this.value = TimestampColumnVector.getTimestampAsLong(value);
    this.outputColumn = outputColumn;
  }

  public LongColNotEqualTimestampScalar() {
  }
