 ...
 */
public class DateScalarSubtractIntervalDayTimeColumn extends VectorExpression {
  ...
  public DateScalarSubtractIntervalDayTimeColumn(long value, int colNum, int outputColumn) {
    this.colNum = colNum;
  ...
  public DateScalarSubtractIntervalDayTimeColumn() {
  }
