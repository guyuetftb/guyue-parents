 ...
 */
public class DoubleColGreaterEqualLongScalar extends VectorExpression {
  ...
  public DoubleColGreaterEqualLongScalar(int colNum, long value, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public DoubleColGreaterEqualLongScalar() {
  }
