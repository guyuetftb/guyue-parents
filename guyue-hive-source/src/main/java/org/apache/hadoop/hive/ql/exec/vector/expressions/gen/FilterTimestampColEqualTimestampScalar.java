 ...
 */
public class FilterTimestampColEqualTimestampScalar extends VectorExpression {
  ...
  public FilterTimestampColEqualTimestampScalar(int colNum, Timestamp value) {
    this.colNum = colNum;
    this.value = value;
  }

  public FilterTimestampColEqualTimestampScalar() {
  }
