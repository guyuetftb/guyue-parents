 ...
 */
public class FilterLongScalarGreaterTimestampColumn extends VectorExpression {
  ...
  public FilterLongScalarGreaterTimestampColumn(long value, int colNum) {
    this.colNum = colNum;
    this.value = value;
  }

  public FilterLongScalarGreaterTimestampColumn() {
  }
