 ...
 */
public class DoubleColNotEqualLongScalar extends VectorExpression {
  ...
  public DoubleColNotEqualLongScalar(int colNum, long value, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public DoubleColNotEqualLongScalar() {
  }
