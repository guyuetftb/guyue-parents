 ...
 */
public class DoubleScalarLessEqualLongColumn extends VectorExpression {
  ...
  public DoubleScalarLessEqualLongColumn(double value, int colNum, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public DoubleScalarLessEqualLongColumn() {
  }
