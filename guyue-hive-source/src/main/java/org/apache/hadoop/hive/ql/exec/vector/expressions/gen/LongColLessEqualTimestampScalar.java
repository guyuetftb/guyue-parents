 ...
 */
public class LongColLessEqualTimestampScalar extends VectorExpression {
  ...
  public LongColLessEqualTimestampScalar(int colNum, Timestamp value, int outputColumn) {
    this.colNum = colNum;
    this.value = TimestampColumnVector.getTimestampAsLong(value);
    this.outputColumn = outputColumn;
  }

  public LongColLessEqualTimestampScalar() {
  }
