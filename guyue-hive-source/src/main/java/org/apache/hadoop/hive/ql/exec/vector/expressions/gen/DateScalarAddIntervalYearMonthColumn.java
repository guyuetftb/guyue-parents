 ...
 */
public class DateScalarAddIntervalYearMonthColumn extends VectorExpression {
  ...
  public DateScalarAddIntervalYearMonthColumn(long value, int colNum, int outputColumn) {
    this.colNum = colNum;
  ...
  public DateScalarAddIntervalYearMonthColumn() {
  }
