 ...
 */
public class LongScalarGreaterTimestampColumn extends VectorExpression {
  ...
  public LongScalarGreaterTimestampColumn(long value, int colNum, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public LongScalarGreaterTimestampColumn() {
  }
