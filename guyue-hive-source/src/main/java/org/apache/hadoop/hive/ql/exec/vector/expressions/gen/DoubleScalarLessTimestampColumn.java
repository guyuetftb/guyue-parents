 ...
 */
public class DoubleScalarLessTimestampColumn extends VectorExpression {
  ...
  public DoubleScalarLessTimestampColumn(double value, int colNum, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public DoubleScalarLessTimestampColumn() {
  }
