 ...
 */
public class VarCharScalarLessStringGroupColumn extends StringGroupScalarLessStringGroupColumnBase {

  private static final long serialVersionUID = 1L;

  public VarCharScalarLessStringGroupColumn(HiveVarchar value, int colNum, int outputColumn) {
    this.colNum = colNum;
    this.value = value.getValue().getBytes();
    this.outputColumn = outputColumn;
  }

  public VarCharScalarLessStringGroupColumn() {
  }
