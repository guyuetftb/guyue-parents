 ...
 */
public class DoubleScalarNotEqualTimestampColumn extends VectorExpression {
  ...
  public DoubleScalarNotEqualTimestampColumn(double value, int colNum, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public DoubleScalarNotEqualTimestampColumn() {
  }
