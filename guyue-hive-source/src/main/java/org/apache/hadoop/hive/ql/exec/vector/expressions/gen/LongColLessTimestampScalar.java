 ...
 */
public class LongColLessTimestampScalar extends VectorExpression {
  ...
  public LongColLessTimestampScalar(int colNum, Timestamp value, int outputColumn) {
    this.colNum = colNum;
    this.value = TimestampColumnVector.getTimestampAsLong(value);
    this.outputColumn = outputColumn;
  }

  public LongColLessTimestampScalar() {
  }
