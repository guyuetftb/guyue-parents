 ...
 */
public class FilterTimestampColNotEqualDoubleScalar extends VectorExpression {
  ...
  public FilterTimestampColNotEqualDoubleScalar(int colNum, double value) {
    this.colNum = colNum;
    this.value = value;
  }

  public FilterTimestampColNotEqualDoubleScalar() {
  }
