 ...
 * values.
 */
public class FilterTimestampScalarNotEqualTimestampColumn extends VectorExpression {
  ...
  public FilterTimestampScalarNotEqualTimestampColumn(Timestamp value, int colNum) {
    this.colNum = colNum;
    this.value = value;
  }

  public FilterTimestampScalarNotEqualTimestampColumn() {
  }
