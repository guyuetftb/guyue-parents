...
public class HiveMetaStore extends ThriftHiveMetastore {
    ...
    public static class HMSHandler extends FacebookBase implements IHMSHandler, ThreadLocalRawStore {
        ...
        public HMSHandler(String name,
                          HiveConf conf,
                          boolean init) throws MetaException {
            super(name);
            hiveConf = conf;
        ...
        public void init() throws MetaException {
            initListeners = MetaStoreUtils.getMetaStoreListeners(
                    ...
                    hiveConf.getVar(ConfVars.METASTORE_INIT_HOOKS));
            ...
            preListeners = MetaStoreUtils.getMetaStoreListeners(MetaStorePreEventListener.class,
                                                                hiveConf,
                                                                hiveConf.getVar(ConfVars.METASTORE_PRE_EVENT_LISTENERS));
            ...
            listeners = MetaStoreUtils.getMetaStoreListeners(MetaStoreEventListener.class, hiveConf,
                                                             hiveConf.getVar(ConfVars.METASTORE_EVENT_LISTENERS));
            ...
            endFunctionListeners = MetaStoreUtils.getMetaStoreListeners(
                    ...
                    hiveConf.getVar(ConfVars.METASTORE_END_FUNCTION_LISTENERS));

            String partitionValidationRegex =
                    hiveConf.getVar(ConfVars.METASTORE_PARTITION_NAME_WHITELIST_PATTERN);
        ...
        @Override
        public void setMetaConf(String key,
                                String value) throws MetaException {
        ...
        private String startTableFunction(String function,
                                          String db,
                                          String tbl) {
            return startFunction(function, " : db=" + db + " tbl=" + tbl);
        }

        private String startMultiTableFunction(String function,
                                               String db,
                                               List<String> tbls) {
        ...
        private String startPartitionFunction(String function,
                                              String db,
                                              String tbl,
        ...
        private void endFunction(String function,
                                 boolean successful,
                                 Exception e) {
        ...
        private void create_database_core(RawStore ms,
                                          final Database db)
        ...
        @Override
        public void alter_database(final String dbName,
                                   final Database db)
         ...
         * @return
         */
        private boolean isSubdirectory(Path parent,
                                       Path other) {
        ...
        @Override
        public void drop_database(final String dbName,
                                  final boolean deleteData,
                                  final boolean cascade)
                throws NoSuchObjectException, InvalidOperationException, MetaException {
        ...
        private void create_type_core(final RawStore ms,
                                      final Type type)
        ...
        private boolean is_type_exists(RawStore ms,
                                       String typeName)
                throws MetaException {
            return (ms.getType(typeName) != null);
        }

        private void drop_type_core(final RawStore ms,
                                    String typeName)
        ...
        private void create_table_core(final RawStore ms,
                                       final Table tbl,
            ...
            try {
                ...
                if (HiveConf.getBoolVar(hiveConf, ConfVars.HIVESTATSAUTOGATHER) &&
        ...
        public void create_table_with_constraints(final Table tbl,
                                                  final List<SQLPrimaryKey> primaryKeys,
        ...
        private boolean is_table_exists(RawStore ms,
                                        String dbname,
                                        String name)
                throws MetaException {
        ...
        private boolean drop_table_core(final RawStore ms,
                                        final String dbname,
                                        final String name,
                                        final boolean deleteData,
                                        final EnvironmentContext envContext,
         ...
         */
        private void checkTrashPurgeCombination(Path pathToData,
                                                String objectName,
                                                boolean ifPurge,
         ...
         * @throws NoSuchObjectException
         */
        private List<Path> dropPartitionsAndGetLocations(RawStore ms,
                                                         String dbName,
                                                         String tableName,
                                                         Path tablePath,
        ...
        @Override
        public void drop_table(final String dbname,
                               final String name,
                               final boolean deleteData)
                throws NoSuchObjectException, MetaException {
        ...
        @Override
        public void drop_table_with_environment_context(final String dbname,
                                                        final String name,
                                                        final boolean deleteData,
                                                        final EnvironmentContext envContext)
                throws NoSuchObjectException, MetaException {
        ...
        @Override
        @Deprecated
        public Table get_table(final String dbname,
                               final String name) throws MetaException,
        ...
        private Table getTableInternal(String dbname,
                                       String name,
        ...
        @Override
        public List<TableMeta> get_table_meta(String dbnames,
                                              String tblNames,
         ...
         * @throws NoSuchObjectException
         */
        public Table get_table_core(final String dbname,
                                    final String name) throws MetaException,
                                                              NoSuchObjectException {
            Table t;
            try {
        ...
        @Override
        @Deprecated
        public List<Table> get_table_objects_by_name(final String dbName,
        ...
        private Partition append_partition_common(RawStore ms,
                                                  String dbName,
                                                  String tableName,
        ...
        @Override
        public Partition append_partition(final String dbName,
        ...
        private boolean startAddPartition(
                RawStore ms,
                Partition part,
                boolean ifNotExists) throws MetaException, TException {
        ...
        private boolean createLocationForAddedPartition(
                final Table tbl,
                final Partition part) throws MetaException {
            Path partLocation = null;
        ...
        private void initializeAddedPartition(
                final Table tbl,
                final PartitionSpecProxy.PartitionIterator part,
                boolean madeDir) throws MetaException {
            if (HiveConf.getBoolVar(hiveConf, ConfVars.HIVESTATSAUTOGATHER) &&
                    !MetaStoreUtils.isView(tbl)) {
        ...
        private boolean drop_partition_common(RawStore ms,
                                              String db_name,
                                              String tbl_name,
                                              List<String> part_vals,
                                              final boolean deleteData,
        ...
        private static boolean isMustPurge(EnvironmentContext envContext,
                                           Table tbl) {
            // Data needs deletion. Check if trash may be skipped.
        ...
        private void deleteParentRecursive(Path parent,
                                           int depth,
                                           boolean mustPurge) throws IOException, MetaException {
        ...
        @Override
        public boolean drop_partition(final String db_name,
        ...
        private static class PathAndPartValSize {
            public PathAndPartValSize(Path path,
                                      int partValSize) {
                this.path = path;
        ...
        @Override
        public Partition get_partition(final String db_name,
                                       final String tbl_name,
         ...
         * @throws NoSuchObjectException
         */
        private void fireReadTablePreEvent(String dbName,
                                           String tblName) throws MetaException, NoSuchObjectException {
        ...
        @Override
        public List<Partition> get_partitions(final String db_name,
                                              final String tbl_name,
        ...
        private void checkLimitNumberOfPartitionsByFilter(String dbName,
                                                          String tblName,
                                                          String filterString,
        ...
        private void checkLimitNumberOfPartitionsByExpr(String dbName,
                                                        String tblName,
                                                        byte[] filterExpr,
                                                        int maxParts) throws TException {
            if (isPartitionLimitEnabled()) {
        ...
        private boolean isPartitionLimitEnabled() {
            int partitionLimit = HiveConf.getIntVar(hiveConf, ConfVars.METASTORE_LIMIT_PARTITION_REQUEST);
            return partitionLimit > -1;
        }

        private void checkLimitNumberOfPartitions(String tblName,
                                                  int numPartitions,
        ...
        @Override
        public List<PartitionSpec> get_partitions_pspec(final String db_name,
                                                        final String tbl_name,
                                                        final int max_parts)
                throws NoSuchObjectException, MetaException {
        ...
        private PartitionSpec getSharedSDPartSpec(Table table,
        ...
        @Override
        public List<String> get_partition_names(final String db_name,
                                                final String tbl_name,
        ...
        @Override
        public void alter_partition(final String db_name,
                                    final String tbl_name,
        ...
        @Override
        public void rename_partition(final String db_name,
                                     final String tbl_name,
                                     final List<String> part_vals,
                                     final Partition new_part)
                throws InvalidOperationException, MetaException, TException {
        ...
        private void rename_partition(final String db_name,
                                      final String tbl_name,
                                      final List<String> part_vals,
                                      final Partition new_part,
                                      final EnvironmentContext envContext)
        ...
        @Override
        public void alter_partitions(final String db_name,
                                     final String tbl_name,
        ...
        @Override
        public void alter_partitions_with_environment_context(final String db_name,
                                                              final String tbl_name,
                                                              final List<Partition> new_parts,
        ...
        @Override
        public void alter_index(final String dbname,
                                final String base_table_name,
        ...
        @Override
        public void alter_table(final String dbname,
                                final String name,
        ...
        @Override
        public void alter_table_with_cascade(final String dbname,
                                             final String name,
                                             final Table newTable,
                                             final boolean cascade)
                throws InvalidOperationException, MetaException {
        ...
        private void alter_table_core(final String dbname,
                                      final String name,
                                      final Table newTable,
                                      final EnvironmentContext envContext)
                throws InvalidOperationException, MetaException {
        ...
        @Override
        public List<String> get_tables(final String dbname,
        ...
        @Override
        public List<String> get_tables_by_type(final String dbname,
                                               final String pattern,
        ...
        @Override
        public List<FieldSchema> get_fields_with_environment_context(String db,
                                                                     String tableName,
                                                                     final EnvironmentContext envContext)
                throws MetaException, UnknownTableException, UnknownDBException {
         ...
         */
        @Override
        public List<FieldSchema> get_schema_with_environment_context(String db,
                                                                     String tableName,
                                                                     final EnvironmentContext envContext)
                throws MetaException, UnknownTableException, UnknownDBException {
        ...
        private List<String> getPartValsFromName(Table t,
                                                 String partName)
                throws MetaException, InvalidObjectException {
        ...
        private List<String> getPartValsFromName(RawStore ms,
                                                 String dbName,
                                                 String tblName,
        ...
        private Partition get_partition_by_name_core(final RawStore ms,
        ...
        @Override
        public Partition get_partition_by_name(final String db_name,
                                               final String tbl_name,
        ...
        @Override
        public Partition append_partition_by_name(final String db_name,
                                                  final String tbl_name,
        ...
        public Partition append_partition_by_name_with_environment_context(final String db_name,
                                                                           final String tbl_name,
                                                                           final String part_name,
                                                                           final EnvironmentContext env_context)
                throws InvalidObjectException, AlreadyExistsException, MetaException, TException {
        ...
        @Override
        public boolean drop_partition_by_name(final String db_name,
                                              final String tbl_name,
                                              final String part_name,
        ...
        @Override
        public Index add_index(final Index newIndex,
        ...
        private Index add_index_core(final RawStore ms,
                                     final Index index,
                                     final Table indexTable)
                throws InvalidObjectException, AlreadyExistsException, MetaException {
        ...
        @Override
        public boolean drop_index_by_name(final String dbName,
                                          final String tblName,
        ...
        @Override
        public Index get_index_by_name(final String dbName,
                                       final String tblName,
        ...
        private Index get_index_by_name_core(final RawStore ms,
                                             final String db_name,
                                             final String tbl_name,
                                             final String index_name)
                throws MetaException, NoSuchObjectException, TException {
        ...
        @Override
        public List<String> get_index_names(final String dbName,
                                            final String tblName,
        ...
        @Override
        public List<Index> get_indexes(final String dbName,
                                       final String tblName,
        ...
        private boolean updatePartitonColStats(Table tbl,
        ...
        @Override
        public boolean delete_partition_column_statistics(String dbName,
                                                          String tableName,
                                                          String partName,
                                                          String colName) throws NoSuchObjectException, MetaException,
        ...
        @Override
        public boolean delete_table_column_statistics(String dbName,
                                                      String tableName,
                                                      String colName)
        ...
        private PrincipalPrivilegeSet get_column_privilege_set(final String dbName,
                                                               ...
                                                               final String userName,
                                                               final List<String> groupNames) throws MetaException,
                                                                                                     TException {
         ...
         * @throws MetaException
         */
        private boolean isNewRoleAParent(String newRole,
                                         String curRole) throws MetaException {
        ...
        @Override
        public boolean revoke_role(final String roleName,
                                   final String userName,
                                   final PrincipalType principalType) throws MetaException, TException {
            return revoke_role(roleName, userName, principalType, false);
        }

        private boolean revoke_role(final String roleName,
                                    final String userName,
                                    final PrincipalType principalType,
        ...
        private List<HiveObjectPrivilege> list_table_privileges(
                ...
                final PrincipalType principalType,
                final String dbName,
                final String tableName) throws MetaException,
                                               TException {
        ...
        @Override
        public boolean add_token(String token_identifier,
                                 String delegation_token) throws TException {
        ...
        @Override
        public void update_master_key(int seq_number,
                                      String key) throws NoSuchObjectException,
                                                         MetaException, TException {
        ...
        @Override
        public void markPartitionForEvent(final String db_name,
                                          final String tbl_name,
        ...
        @Override
        public boolean isPartitionMarkedForEvent(final String db_name,
                                                 final String tbl_name,
                                                 final Map<String, String> partName,
                                                 final PartitionEventType evtType) throws
        ...
        @Override
        public List<String> set_ugi(String username,
                                    List<String> groupNames) throws MetaException,
                                                                    TException {
        ...
        @Override
        public void drop_function(String dbName,
                                  String funcName)
                throws NoSuchObjectException, MetaException,
        ...
        @Override
        public void alter_function(String dbName,
                                   String funcName,
                                   Function newFunc)
                throws InvalidOperationException, MetaException, TException {
        ...
        @Override
        public List<String> get_functions(String dbName,
                                          String pattern)
                throws MetaException {
        ...
        @Override
        public Function get_function(String dbName,
                                     String funcName)
                throws MetaException, NoSuchObjectException, TException {
        ...
        private Table getTable(String dbName,
                               String tableName)
                throws MetaException, InvalidObjectException {
    ...
    public static IHMSHandler newRetryingHMSHandler(IHMSHandler baseHandler,
                                                    HiveConf hiveConf)
            throws MetaException {
    ...
    public static Iface newRetryingHMSHandler(String name,
                                              HiveConf conf,
                                              boolean local)
            throws MetaException {
        ...
        try {
            ...
            if (useSasl) {
                ...
                saslServer = bridge.createServer(
                        ...
                        conf.getVar(ConfVars.METASTORE_KERBEROS_PRINCIPAL));
                ...
                processor = saslServer.wrapProcessor(
                        new Processor<IHMSHandler>(handler));
            ...
            TServerEventHandler tServerEventHandler = new TServerEventHandler() {
                ...
                @Override
                public ServerContext createContext(TProtocol tProtocol,
    ...
    private static void signalOtherThreadsToStart(final TServer server,
     ...
     */
    private static void startMetaStoreThreads(final HiveConf conf,
                                              final Lock startLock,
                                              final Condition startCondition,
                                              final
    ...
    private static void startHouseKeeperService(HiveConf conf,
