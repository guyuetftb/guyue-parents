...
public class OperationLog {
    ...
    public OperationLog(String name,
                        File file,
                        HiveConf hiveConf) throws FileNotFoundException {
        operationName = name;
     ...
     * @param operationLogMessage one line of log emitted from log4j
     */
    public void writeOperationLog(LoggingLevel level,
                                  String operationLogMessage) {
     ...
     */
    public List<String> readOperationLog(boolean isFetchFirst,
                                         long maxRows)
            throws SQLException {
    ...
    private class LogFile {
        ...
        synchronized List<String> read(boolean isFetchFirst,
                                       long maxRows)
                throws SQLException {
