...
public class ParseDriver {
	...
	public static final TreeAdaptor adaptor = new CommonTreeAdaptor() {
		...
		@Override public Object dupNode(Object t) {

			return create(((CommonTree) t).token);
		}

		@Override public Object errorNode(TokenStream input, Token start, Token stop, RecognitionException e) {
	...
	public ASTNode parse(String command) throws ParseException {
		...
		ASTNode ast = parse(command, null);
	...
	public ASTNode parse(String command, Context ctx) throws ParseException {
		...
		ASTNode ast = parse(command, ctx, null);
		LOG.info(LOG_GY_PREFIX + LOG_GY_BEGIN + " 22 parse(String,Context) ");
		return ast;
	}
	...
	public ASTNode parse(String command, Context ctx, String viewFullyQualifiedName) throws ParseException {
		...
		LOG.info(LOG_GY_PREFIX + " \t 1 parse(String,Context,String) command = " + command);
		LOG.info(LOG_GY_PREFIX + " \t 2 parse(String,Context,String) tree = " + tree.toStringTree());
		LOG.info(LOG_GY_PREFIX + " \t 3 parse(String,Context,String) viewFullyQualifiedName = "
