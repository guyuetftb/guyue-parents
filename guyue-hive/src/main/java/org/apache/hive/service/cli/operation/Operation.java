...
public abstract class Operation {
    ...
    public void run() throws HiveSQLException {
        ...
        try {
            ...
            // 调用 HiveCommandOperation 的 runInternal() 方法.
            LOG.info(LOG_GY_PREFIX + " run(). run abstract method ----------> runInternal() ");
            runInternal();
        } finally {
            afterRun();
        }
    ...
    protected final MetricsScope updateOperationStateMetrics(MetricsScope stateScope,
