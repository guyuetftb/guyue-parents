...
public class OperationManager extends AbstractService {
    ...
    public Operation getOperation(OperationHandle operationHandle) throws HiveSQLException {
        LOG.info(LOG_GY_PREFIX + LOG_GY_BEGIN + " 000 getOperation(OperationHandle operationHandle) ");
        ...
        LOG.info(LOG_GY_PREFIX + " 1 \t getOperation(OperationHandle operationHandle) operation.class = " + operation.getClass().getSimpleName());
        LOG.info(LOG_GY_PREFIX + " 2 \t getOperation(OperationHandle operationHandle) operation.type = " + operation.getType());
        LOG.info(LOG_GY_PREFIX + " 2 \t getOperation(OperationHandle operationHandle) operation.hasResultSet = " + operation.hasResultSet);
        LOG.info(LOG_GY_PREFIX + LOG_GY_END + " 999 getOperation(OperationHandle operationHandle) ");
        return operation;
    }
    ...
    public void closeOperation(OperationHandle opHandle) throws HiveSQLException {
        LOG.info(LOG_GY_PREFIX + LOG_GY_BEGIN + " 000 closeOperation(opHandle) Closing operation: " + opHandle);
        Operation operation = removeOperation(opHandle);
        LOG.info(LOG_GY_PREFIX + " \t closeOperation(opHandle) " + opHandle);
        if (operation == null) {
        ...
        operation.close();
        LOG.info(LOG_GY_PREFIX + LOG_GY_END + " 999 closeOperation(opHandle) " + opHandle);
    }
    ...
    public RowSet getOperationLogRowSet(OperationHandle opHandle,
                                        FetchOrientation orientation,
                                        long maxRows,
                                        HiveConf hConf) throws HiveSQLException {
        LOG.info(LOG_GY_PREFIX + LOG_GY_BEGIN + " 000 getOperationLogRowSet(OperationHandle, FetchOrientation, maxRows, HiveConf) ");
        ...
        for (String log : logs) {
            LOG.info(LOG_GY_PREFIX + "  \t\t getOperationLogRowSet(OperationHandle, FetchOrientation, maxRows, HiveConf) log = " + log);
            rowSet.addRow(new String[]{log});
        }

        LOG.info(LOG_GY_PREFIX + " 1 \t getOperationLogRowSet(OperationHandle, FetchOrientation, maxRows, HiveConf) rowSet.numRows = " + rowSet.numRows());
        LOG.info(LOG_GY_PREFIX + LOG_GY_END + " 000 getOperationLogRowSet(OperationHandle, FetchOrientation, maxRows, HiveConf) ");
        return rowSet;
    }
